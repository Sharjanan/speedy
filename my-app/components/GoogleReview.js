...
const GOOGLE_API_KEY = "AIzaSyBnpDw8PX6uMBx7OXuWzrrQtTrDOrAoxXg"; // 🔹 Replace with your API key
const PLACE_ID = "ChIJl6xk9wIbyUwR9r7-3s6Xb7M"; // 🔹 Replace with your Google Place ID
